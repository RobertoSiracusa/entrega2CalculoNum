...
def generate_scalable_bin_file_v3(file_name="", num_lines=0, max_numbers_per_line=0, number_range=(0, 999999)):
...
if __name__ == "__main__":
    generate_scalable_bin_file_v3(
        ...
        num_lines=999,
        max_numbers_per_line=999,
        number_range=(-999999, 999999)
    )